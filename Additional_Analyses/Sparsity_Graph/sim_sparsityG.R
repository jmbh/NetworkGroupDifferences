# jonashaslbeck@gmail.com; March 9, 2021
...
# source("Additional_Analyses/Sparsity_Graph/aux_functions.R") # source helper functions
...
out <- foreach(ni = 1:10,
               ...
               .verbose=TRUE) %dopar% {
                 ...
                 for(del in 1:3) {
                   ...
                   # Verb
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "NCT", "Timing = ", round(m_time[1, del])))
                   ...
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "FGL BIC", "Timing = ", round(m_time[3, del])))
                   ...
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "FGL EBIC", "Timing = ", round(m_time[4, del])))
                   ...
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "FGL VV", "Timing = ", round(m_time[5, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "BGGM BF", "Timing = ", round(m_time[6, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "BGGM Post an", "Timing = ", round(m_time[7, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "BGGM Post samp", "Timing = ", round(m_time[8, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "MGM BIC AND", "Timing = ", round(m_time[9, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "MGM EBIC AND", "Timing = ", round(m_time[10, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "MGM CV AND", "Timing = ", round(m_time[11, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "MGM BIC OR", "Timing = ", round(m_time[12, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "MGM EBIC OR", "Timing = ", round(m_time[13, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "MGM CV OR", "Timing = ", round(m_time[14, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "Fisher", "Timing = ", round(m_time[15, del])))
                   ...
                   # Verbatim
                   cat(paste("Iter =", iter, "ni =", ni, "del =", del, "Psychonetrics", "Timing = ", round(m_time[17, del])))
                   ...
                   m_time[18, del] <-  proc.time()[3] - timer
...
saveRDS(outlist, file=paste0("Simresults_SparsityG_Iter", iter, ".RDS"))
